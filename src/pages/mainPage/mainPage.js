                ...
                <div className="col-xs-12">
                    <section className="row siteBody__introduction">
                        <div className="col-xs-10 col-xs-offset-1 col-md-8 col-md-offset-2 text-center">
                            ...
                            <p>
                                MySchedule - это информационный портал, который позволит вам легко узнать интересующее
                                Вас расписание в 2 клика или создать своё собственное!<br/>Один аккаунт - множество
                                возможностей
                            </p>
                        </div>
                    </section>
                    <section className="row siteBody__instruction">
                        <section
                            ...
                            <div className="contentCol__text">
                                ...
                                <p>
                                    <Link to="/registration">Зарегистрируй</Link> себя и свое заведение, чтобы получить
                                    полный доступ к редактированию расписания. Заполняй важную информацию, добавляй
                                    события!
                                </p>
                            </div>
                        </section>
                        ...
                        <section
                            ...
                            <div className="contentCol__text">
                                ...
                                <p>
                                    Воспользуйся нашим сайтом, выбери учебное заведение ниже, найди свою группу и узнай
                                    расписание. Все просто! Регистрироваться нет необходимости!
                                </p>
                            </div>
                        </section>
                    </section>
